class User < ActiveRecord::Base
	...
	def create_reset_digest
		...
		update_attribute(:reset_digest, User.digest(reset_token)) # Update Attribute to update the database
		update_attribute(:reset_sent_at, Time.zone.now) # Update reset email sent at time
	end
